# app.py — trading bot with EMA+Donchian signals + integrated keep-alive loop (pings /ping)
...
# --- Keep-alive (your loop style) ---
APP_BASE_URL  = os.environ.get("APP_BASE_URL", "https://coin-4k37.onrender.com").rstrip("/")
